      ...
      <div class="bs-docs-section">
        ...
        <!-- END MENU -->
          ...
          <div class="col-lg-7">
            ...
            <?php 
            include("config.php");
            $results=$mysqli->query("SELECT count(*) as total_q from questions where title like '%{$search}%'");
            $total_records=$results->fetch_object();
            $total_groups =ceil($total_records->total_q/$items_per_group);
            $results->close();
          ?>
          <?php include("config.php");
          $resu=$mysqli->query("SELECT * from questions where title like '%{$search}%'");
          while($result_q=$resu->fetch_object()){
          ?>
              <div class="row">
